      ...
      <div className="flex w-full justify-center items-center mx-auto flex-col px-4 md:px-6 pb-20">
        ...
        <div className="w-full bg-[#111827] border border-gray-600 p-5 lg:p-8 rounded-2xl shadow-xl flex flex-col lg:items-center relative mt-6">
          <div className="flex w-full flex-col">
            ...
            <div className="italic text-xs mt-8 mb-3 flex flex-row">
              Note: leave switch enabled for
              <br /> NFT drops: (Multiple Artworks. Different media for each
              token.) <br />
              disable switch for Single Artwork: ( One or multiple copies.)
            </div>
            <div className="flex items-center space-x-2">
              <Switch
                checked={isDrop}
                onCheckedChange={(e: boolean) => setIsDrop(e)}
                id="public"
                className="border border-gray-600"
              />
              <label
