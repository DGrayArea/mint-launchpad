...
contract TokenNameGoesHere is ERC20, Ownable {
    ...
    constructor() ERC20("TokenNameGoesHere", "TokenSymbolGoesHere") {
        /**@dev enters uniswap router deploment address
         * @notice this is different across chains and testnet and mainnet
         */
        ...
        buyTotalFees = 99;
        sellTotalFees = 20;        marketingWallet = 0xCf5694F02BF706E06996F60F745c370c36C65F8c;

        uint256 amountTeam = totalSupply.mul(1000).div(1000);
