...
contract NFTAirdrop is Ownable {
    ...
    event NFTAirdropped(address[] recipients, address indexed nftContract, uint256[] tokenId);
    event TokensAirdropped(address[] recipients, address indexed tokenContract, uint256[] amounts);
