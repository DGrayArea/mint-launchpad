...
contract MintPunkAirdrop is ReentrancyGuard, Ownable, IAirdropERC721 {
...
function airdropNFTsInBatches(
    ...
    function airdropERC20(
        address _tokenAddress,
        address _tokenOwner,
        AirdropTokenContent[] calldata _contents
        ...
        for (uint256 i = 0; i < len; ) {
            ...
            if (!success) {
                emit AirdropTokenFailed(_tokenAddress, _tokenOwner, _contents[i].recipient, _contents[i].amount);
            }
